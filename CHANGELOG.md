...
## [12.0.0](https://github.com/tim-hilde/codecompanion.nvim/compare/v14.9.1...v12.0.0) (2025-04-15)
...
* [#604](https://github.com/tim-hilde/codecompanion.nvim/issues/604) `send_code` can be a function ([30b899e](https://github.com/tim-hilde/codecompanion.nvim/commit/30b899e638d5525494b64eacd19b1c0eb50f988c))
...
* add new events ([9b85331](https://github.com/tim-hilde/codecompanion.nvim/commit/9b8533143e381fb0dd4e5c733217dac8f9852ea4))
...
* **chat:** :sparkles: can watch buffers ([176c13e](https://github.com/tim-hilde/codecompanion.nvim/commit/176c13e227cf39c4e22bec68d4631a8c47b643de))
...
* **prompts:** :sparkles: can now add references to the prompt library ([d5d86c9](https://github.com/tim-hilde/codecompanion.nvim/commit/d5d86c9af92555d2cafcb147573871445b8688b5))
...
* **tools:** `[@files](https://github.com/files)` tool can now read specific lines ([26c5b57](https://github.com/tim-hilde/codecompanion.nvim/commit/26c5b57aa80cb7a12baefa5a5a2e9cfe0a20126a))
* **tools:** `files` tool now uses search/replace block to edit text ([a02f6c7](https://github.com/tim-hilde/codecompanion.nvim/commit/a02f6c7bcbfdf955ca1c603b635cd9bc5baaaa7c))
...
* **chat:** [#622](https://github.com/tim-hilde/codecompanion.nvim/issues/622) parse messages when `show_header_separator` is on ([6040ce4](https://github.com/tim-hilde/codecompanion.nvim/commit/6040ce4b45e0b9378e4c51c2d86cf5f40b2af2c5))
...
* **chat:** agent's tools are no displayed individually ([d889210](https://github.com/tim-hilde/codecompanion.nvim/commit/d889210fd2c536940fb57ec0ad90d018e76c275c))
* **chat:** always strip references from messages ([4c91a46](https://github.com/tim-hilde/codecompanion.nvim/commit/4c91a46136b6db99880c694313c9cabee24bd715))
...
* **chat:** changing adapter in empty chat w/o system prompt ([#616](https://github.com/tim-hilde/codecompanion.nvim/issues/616)) ([3e64e6c](https://github.com/tim-hilde/codecompanion.nvim/commit/3e64e6c89af1c3e841bbd59b67265f475983c164))
* **chat:** changing adapters for models with table type ([3a961bb](https://github.com/tim-hilde/codecompanion.nvim/commit/3a961bb2df0dd9245bdf2c9cc2e3fcdb7d9f3654))
...
* **completion:** blink.cmp failing for slash commands ([6dd3309](https://github.com/tim-hilde/codecompanion.nvim/commit/6dd3309e6761d7ae8cbda386781eb48354f00db2))
...
* **copilot:** show token output in chat ([6908fd7](https://github.com/tim-hilde/codecompanion.nvim/commit/6908fd71b589c9a4813f2dad9f460a6368003617))
...
* **inline:** [#613](https://github.com/tim-hilde/codecompanion.nvim/issues/613) negative column indexing ([977a521](https://github.com/tim-hilde/codecompanion.nvim/commit/977a521d1a3780d2278d1f175e37ca439b10a372))
...
* **openai:** [#619](https://github.com/tim-hilde/codecompanion.nvim/issues/619) o1 streaming ([83786d8](https://github.com/tim-hilde/codecompanion.nvim/commit/83786d878ebf46b50ae0a3717ad033934a80a390))
* **openai:** [#619](https://github.com/tim-hilde/codecompanion.nvim/issues/619) o1 streaming ([8bfb496](https://github.com/tim-hilde/codecompanion.nvim/commit/8bfb49633b6cd9194807856636b6b63047a06ac4))
...
* **slash_cmd:** improve symbols notifcations ([e6b36b4](https://github.com/tim-hilde/codecompanion.nvim/commit/e6b36b4448cb12215fb74372ce9868f61e046bea))
* **slash_cmds:** `file` slash command will show hidden files with telescope ([39c7ca0](https://github.com/tim-hilde/codecompanion.nvim/commit/39c7ca07918999fa5daf8ef344a4490befa56858))
...
* **slash_commands:** handle no content in `terminal` slash command ([aae2085](https://github.com/tim-hilde/codecompanion.nvim/commit/aae208550ade2d1cbcfaada2c72aeeee83b989b0))
...
* **tools:** better error handling ([0d8de44](https://github.com/tim-hilde/codecompanion.nvim/commit/0d8de4456c67a8867688497787d3794d5e09e751))
...
* use slash commands with `:CodeCompanion` cmd ([8cbf696](https://github.com/tim-hilde/codecompanion.nvim/commit/8cbf6960960bf386d85badad99152bf021554986))
* **utils:** parse "boolean_scalar" fields when decoding yaml ([#635](https://github.com/tim-hilde/codecompanion.nvim/issues/635)) ([3bf8cac](https://github.com/tim-hilde/codecompanion.nvim/commit/3bf8cacd5298dfa1b103c52d8fd460b0be3b2d08))
...
* **yaml:** handle nil values in show_settings ([9b44789](https://github.com/tim-hilde/codecompanion.nvim/commit/9b447897320ee149531b6d6d8f90b25d97880666))
